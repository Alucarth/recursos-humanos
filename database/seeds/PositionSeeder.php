...
class PositionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $positions = [
            ...
            ["name" =>"Gerente de Planificacion y Desarrollo"],
            ["name"=>"Asistente Administrativo"],
            ["name"=>"Responsable de Proyectos"],
            ["name"=>"Profesional en Proyectos"],
            ["name"=>"Tecnico en Proyectos II"],
            ["name"=>"Profecional en Calculo y Diseño de Obras Civiles"],
            ["name"=>"Tecnico en Proyectos I"],
            ["name"=>"Profesional en Infraestructura"],
            ["name"=>"Profesional en Inspeccion de Obras Civiles"],
            ["name"=>"Tecnico en Gestion Ambiental"],
            ...
            ["name"=>"Asistente Descargo de Viaticos La Paz"],
            ["name"=>"Responsable Administrativo"],
            ["name"=>"Encargado de Servicios Generales"],
            ["name"=>"Auxiliar Servicios Generales"],
            ["name"=>"Tecnico Financiero Servicios Generales"],
            ["name"=>"Encargado de Activos Fijos"],
            ["name"=>"Tecnico en Almacenes"],
            ["name"=>"Tecnico en Activo Fijos"],
            ["name"=>"Tecnico Activos Fijos La Paz"],
            ["name"=>"Tecnico en Almacenes I"],
            ...
            ["name"=>"Responsable de Tesoreria"],
            ["name"=>"Encargado de Tesoreria"],
            ["name"=>"Auxiliar Financiera Distribucion"],
            ["name"=>"Tecnico Administrativo Financiero"],
            ["name"=>"Jefe de Unidad Financiera"],
            ["name"=>"Apoyo Responsable de Contabilidad"],
            ["name"=>"Auxiliar Apoyo Contable"],
            ["name"=>"Auxiliar Financiera GAF"],
            ["name"=>"Responsable de Contabiliad"],
