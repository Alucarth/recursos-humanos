...
class RequestTypeSeeder extends Seeder
{
    ...
    public function run()
    {
        //
        $request_types = [
            ['name'=>'COMISIÓN','label1'=>'Si la comisión incluye horario o día no laboral, el Servidor Público acepta la Comisión marcar la casilla SI y firmar el documento','description'=>'Para actividades de carácter institucional en lugares diferentes al habitual con plazos mayores a una jornada','version'=>'01','code'=>'FOR-RRHH-01'],
            ...
            ['name'=>'ASUETO','description'=>'Permiso para suspender actividades por un periodo determinado para actividades de manera específica o de manera libre','version'=>'01','code'=>'FOR-RRHH-03'],
            ...
            ['name'=>'DESCANSO ANUAL','label1'=>'Periodo de descanso anual(Dias)','label2'=>'Fecha de Presentacion','label3'=>'Mañana','label4'=>'Tarde','description'=>'','version'=>'01','code'=>'FOR-RRHH-08'],
        ];
