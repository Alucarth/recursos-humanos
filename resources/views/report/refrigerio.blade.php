...
@section('content')
  ...
  @foreach ($refrigerio as $item)
        <tr class="text-sm">
            ...
            <td class="text-center text-xxs uppercase font-bold px-5 py-3">{{ $item->full_name }}</td>
    ...
    @endforeach
    <tr class="text-sm">
        <td class="text-center text-xxs uppercase font-bold px-15 py-3 bg-grey-darker text-white" colspan="11">TOTALES</td>
