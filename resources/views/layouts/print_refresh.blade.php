                    ...
                    <table class="table-code align-top no-padding no-margins">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-xs">{!! $username->usr_usuario !!}</td>
                            </tr>
                            @if(isset($code))
                            <tr>
                                <td class="text-center bg-grey-darker text-xxs text-white">Unidad</td>
                                <td class="text-xs">RRHH</td>
                            </tr>
                            @endif
                             <tr>
                                <td class="text-center bg-grey-darker text-xxs text-white">Planta</td>
                                <td class="text-xs">{{ $location->name }}</td>
                            </tr>
                        </tbody>
                    </table>
